...
export function MapStatic() {
  return (
    <section aria-labelledby="map-title" className="container-site py-20">
      <h2 id="map-title" className="text-2xl font-semibold">
        Carte des implantations
      </h2>
      <div className="mt-6 grid gap-6 lg:grid-cols-2">
        <div className="aspect-[16/10] rounded-xl bg-neutral-100 relative overflow-hidden flex items-center justify-center">
        ...
        <div className="grid gap-6">
          <div>
            <h3 className="font-semibold">Centres ouverts</h3>
          ...
          <div>
            <h3 className="font-semibold">Prochaines ouvertures</h3>
            <ul className="mt-2 grid grid-cols-2 gap-2 text-sm text-neutral-700">
              {nextOpenings.map((n) => (
                <li key={n} className="flex items-center gap-2">
